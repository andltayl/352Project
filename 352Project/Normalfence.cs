...
{
    class NormalFence : Fence
    {
        private double approaching = 2;   //how fast fences move
        private int wOfBetween = 60;       //space between fences
        private int sumTotal = 80;         //points given between difficulty

        public double Approaching { get { return approaching; } }               //to return approaching

        public NormalFence() : base() { }
