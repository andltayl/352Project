...
{
    class EasyFence : Fence
    {
        private double approaching = 1;   //how fast fences move
        private int wOfBetween = 80;       //space between fences
        private int sumTotal = 160;         //points given between difficulty

        public double Approaching { get { return approaching; } }               //to return approaching

        public EasyFence() : base()
        {
