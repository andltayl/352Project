...
\begin{figure}[ht!]
\includegraphics[height=250px, width=350px]{Scoreboard_Screen.png}
\caption{First picture, This is the 5\textsubscript{th} Mock-Interface.}
\label{cat1}
\end{figure}

\begin{figure}[ht!]
\includegraphics[height=250px, width=350px]{High_Score_Screen.png}
\caption{Second picture, This is the last Mock-Interface.}
\label{cat1}
\end{figure}
